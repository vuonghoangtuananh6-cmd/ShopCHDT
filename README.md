# ShopQLCHDT - Hệ Thống Quản Lý Cửa Hàng Điện Thoại
...
* **ORM (Object-Relational Mapping):** Entity Framework 6.5.1
* **Cơ sở dữ liệu:** SQL Server
* **Trình biên dịch:** .NET Compiler Platform (Roslyn) 2.0.1

### Frontend

* **Giao diện & Styling:** HTML5, CSS3
...
* **Phân quyền người dùng:** Quản lý quyền truy cập phân cấp rõ ràng (Admin, Nhân viên, Khách hàng).
* **Giao diện đáp ứng (Responsive):** Thiết kế thân thiện, tương thích tốt trên nhiều kích thước màn hình thiết bị khác nhau nhờ vào Bootstrap 5.

* **Phát triển bởi:** Vương Hoàng Tuấn Anh
